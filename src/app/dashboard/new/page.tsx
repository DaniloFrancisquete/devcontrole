        ...
        <Container>
            <main className="mt-9 mb-2">
                ...
                <form  className="flex flex-col mt-6" action={handleRegisterTicket}>
                    ...
                    <input className="w-full border-2 rounded-md px-2 mb-2 h-11"
                    type="text"
                     ...
                     ></textarea>
                      ...
                      {customers.length === 0 && (
                        <Link href="/dashboard/customer/new">
                            Você ainda não tem nenhum cliente,<span className="text-blue-500 font-medium">Cadatrar cliente</span>
                        </Link>
                      )}
